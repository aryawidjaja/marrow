...
# Consolidation merges memories, so it stays something the user asks for. The briefing points it out
# when duplicates have piled up; nothing here rewrites the brain behind their back.
